...
int main(int argc, char** argv) {
	...
	auto trace = builder.then(E(batteryStateIN,Battery{1})).then(E(batteryStatusOUT,BatteryStatus::SafetyCritical())).then(E(batteryStateIN,Battery{0})).then(E(batteryStatusOUT,BatteryStatus::MissionCritical()));
	...
	checker = checker.initially(test.getMessages()).then(E(batteryStateIN,Battery{1})).then(E(batteryStatusOUT,BatteryStatus::SafetyCritical())).pass(E(batteryStateIN,Battery{0})).forbid(E(batteryStatusOUT,BatteryStatus::MissionCritical()));
