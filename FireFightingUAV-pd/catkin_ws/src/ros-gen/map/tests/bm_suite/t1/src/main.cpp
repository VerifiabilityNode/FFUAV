...
int main(int argc, char** argv) {
	...
	auto trace = builder.then(E(batteryStatusOUT,BatteryStatus::MissionCritical()));
	...
	checker = checker.initially(test.getMessages()).pass().forbid(E(batteryStatusOUT,BatteryStatus::MissionCritical()));
