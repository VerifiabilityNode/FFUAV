...
int main(int argc, char** argv) {
	...
	auto trace = builder.then(E(batteryStateIN,Battery{0})).then(E(batteryStatusOUT,BatteryStatus::SafetyCritical())).then(E(batteryStateIN,Battery{4})).then(E(batteryStateIN,Battery{3}));
	...
	checker = checker.initially(test.getMessages()).then(E(batteryStateIN,Battery{0})).then(E(batteryStatusOUT,BatteryStatus::SafetyCritical())).pass(E(batteryStateIN,Battery{4})).forbid(E(batteryStateIN,Battery{3}));
