...
int main(int argc, char** argv) {
	...
	auto trace = builder.then(E(batteryStateIN,Battery{0})).then(E(batteryStateIN,Battery{4}));
	...
	checker = checker.initially(test.getMessages()).pass(E(batteryStateIN,Battery{0})).forbid(E(batteryStateIN,Battery{4}));
