...
int main(int argc, char** argv) {
	...
	auto trace = builder.then(E(batteryStateIN,Battery{3})).then(E(batteryStatusOUT,BatteryStatus::MissionCritical())).then(E(batteryStateIN,Battery{4})).then(E(batteryStatusOUT,BatteryStatus::Ok())).then(E(batteryStatusOUT,BatteryStatus::Ok()));
	...
	checker = checker.initially(test.getMessages()).then(E(batteryStateIN,Battery{3})).then(E(batteryStatusOUT,BatteryStatus::MissionCritical())).then(E(batteryStateIN,Battery{4})).pass(E(batteryStatusOUT,BatteryStatus::Ok())).forbid(E(batteryStatusOUT,BatteryStatus::Ok()));
