...
int main(int argc, char** argv) {
	...
	auto trace = builder.then(E(batteryStateIN,Battery{4})).then(E(batteryStatusOUT,BatteryStatus::Ok())).then(E(batteryStateIN,Battery{2})).then(E(batteryStateIN,Battery{2}));
	...
	checker = checker.initially(test.getMessages()).then(E(batteryStateIN,Battery{4})).then(E(batteryStatusOUT,BatteryStatus::Ok())).pass(E(batteryStateIN,Battery{2})).forbid(E(batteryStateIN,Battery{2}));
