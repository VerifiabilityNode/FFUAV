...
int main(int argc, char** argv) {
	...
	auto trace = builder.then(E(batteryStateIN,Battery{3})).then(E(batteryStatusOUT,BatteryStatus::MissionCritical())).then(E(batteryStateIN,Battery{2})).then(E(batteryStateIN,Battery{3}));
	...
	checker = checker.initially(test.getMessages()).then(E(batteryStateIN,Battery{3})).then(E(batteryStatusOUT,BatteryStatus::MissionCritical())).pass(E(batteryStateIN,Battery{2})).forbid(E(batteryStateIN,Battery{3}));
