...
//	// pumpOff()
//	operation pumpOff { 
//		equation UAV::payload::Dispenser::Nozzle.V == 0
//	}
//	// pumpOn()
//	operation pumpOn { 
...
//		equation UAV::payload::Pole::GCS.inp == missionString(e) // Maps enumerated value to a string.
//	}
//	
//	/******************************************************************************************
