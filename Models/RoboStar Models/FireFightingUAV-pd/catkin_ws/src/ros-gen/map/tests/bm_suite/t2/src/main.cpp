...
int main(int argc, char** argv) {
	...
	auto trace = builder.then(E(batteryStatusOUT,BatteryStatus::SafetyCritical()));
	...
	checker = checker.initially(test.getMessages()).pass().forbid(E(batteryStatusOUT,BatteryStatus::SafetyCritical()));
