...
int main(int argc, char** argv) {
	...
	auto trace = builder.then(E(batteryStateIN,Battery{0})).then(E(batteryStatusOUT,BatteryStatus::SafetyCritical())).then(E(batteryStateIN,Battery{3})).then(E(batteryStatusOUT,BatteryStatus::MissionCritical())).then(E(batteryStatusOUT,BatteryStatus::SafetyCritical()));
	...
	checker = checker.initially(test.getMessages()).then(E(batteryStateIN,Battery{0})).then(E(batteryStatusOUT,BatteryStatus::SafetyCritical())).then(E(batteryStateIN,Battery{3})).pass(E(batteryStatusOUT,BatteryStatus::MissionCritical())).forbid(E(batteryStatusOUT,BatteryStatus::SafetyCritical()));
