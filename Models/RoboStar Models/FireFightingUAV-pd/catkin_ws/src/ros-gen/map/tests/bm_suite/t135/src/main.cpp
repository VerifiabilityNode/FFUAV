...
int main(int argc, char** argv) {
	...
	auto trace = builder.then(E(batteryStateIN,Battery{2})).then(E(batteryStatusOUT,BatteryStatus::MissionCritical())).then(E(batteryStateIN,Battery{0})).then(E(batteryStateIN,Battery{0}));
	...
	checker = checker.initially(test.getMessages()).then(E(batteryStateIN,Battery{2})).then(E(batteryStatusOUT,BatteryStatus::MissionCritical())).pass(E(batteryStateIN,Battery{0})).forbid(E(batteryStateIN,Battery{0}));
