...
int main(int argc, char** argv) {
	...
	auto trace = builder.then(E(batteryStateIN,Battery{0})).then(E(batteryStatusOUT,BatteryStatus::SafetyCritical())).then(E(batteryStateIN,Battery{2})).then(E(batteryStatusOUT,BatteryStatus::MissionCritical())).then(E(batteryStatusOUT,BatteryStatus::MissionCritical()));
	...
	checker = checker.initially(test.getMessages()).then(E(batteryStateIN,Battery{0})).then(E(batteryStatusOUT,BatteryStatus::SafetyCritical())).then(E(batteryStateIN,Battery{2})).pass(E(batteryStatusOUT,BatteryStatus::MissionCritical())).forbid(E(batteryStatusOUT,BatteryStatus::MissionCritical()));
