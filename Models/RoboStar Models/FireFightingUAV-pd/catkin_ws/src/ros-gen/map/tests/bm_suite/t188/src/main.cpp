...
int main(int argc, char** argv) {
	...
	auto trace = builder.then(E(batteryStateIN,Battery{3})).then(E(batteryStateIN,Battery{3}));
	...
	checker = checker.initially(test.getMessages()).pass(E(batteryStateIN,Battery{3})).forbid(E(batteryStateIN,Battery{3}));
