...
int main(int argc, char** argv) {
	...
	auto trace = builder.then(E(fcMissionWPUpload,std::tuple<std::vector<Position>>{{2,2,1}}));
	...
	checker = checker.initially(test.getMessages()).pass().forbid(E(fcMissionWPUpload,std::tuple<std::vector<Position>>{{2,2,1}}));
