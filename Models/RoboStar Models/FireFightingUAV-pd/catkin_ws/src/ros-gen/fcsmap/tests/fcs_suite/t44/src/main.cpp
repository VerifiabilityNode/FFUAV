...
int main(int argc, char** argv) {
	...
	auto trace = builder.then(E(fcDroneTaskControl,std::tuple<M600Task::M600Task>{M600Task::TakeOff()}));
	...
	checker = checker.initially(test.getMessages()).pass().forbid(E(fcDroneTaskControl,std::tuple<M600Task::M600Task>{M600Task::TakeOff()}));
